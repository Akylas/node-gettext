...
var parse_locale_data = function(locale_data, l) {
    ...
    for (domain in locale_data) {
        ...
        for (var key in data.items) {
            ...
            console.log(item.msgid,msg_ctxt_id);
...
Gettext.prototype = {
    loadLanguageFile: function(file, l, callback) {
        ...
        if (typeof(file) == 'function') {
            // interpret file as a function which passes a JSON object to a callback.
            return file(function(json) {
                console.log("gettext called back. json:");
                console.log(json);

                // send locale_data to be parsed.
